...
import { BUILT_IN_GEMS } from '@cr/core';
import App from '../App';

vi.mock('@cr/core/src/providers/CognitivePlatformContext', () => ({
  useCognitivePlatform: () => ({
    auth: { getStatus: () => 'anonymous', getUser: () => undefined, login: vi.fn(), logout: vi.fn(), init: vi.fn(), onChange: vi.fn() },
    storage: { 
...
vi.mock('@cr/ui', () => ({
  SemanticGraph: () => <div data-testid="semantic-graph" />,
