...
exports.appendDiagnostic = appendDiagnostic;
exports.readDiagnosticLog = readDiagnosticLog;
 ...
 */
function getLogPath(storagePath) {
 ...
 */
function appendDiagnostic(storagePath, entry) {
    try {
 ...
 */
function readDiagnosticLog(storagePath) {
    const logPath = getLogPath(storagePath);
    if (!fs.existsSync(logPath)) {
        return '';
    }
 ...
 */
function formatDiagnosticReport(ndjson) {
    if (!ndjson.trim()) {
